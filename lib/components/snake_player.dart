...
// Classe principal do player — lógica de movimento, boost, colisão.
// Render e expressões ficam nos mixins PlayerRenderer / PlayerExpressions.
import 'dart:ui';
import 'package:flame/components.dart';
import 'package:flame/events.dart';
import 'package:flutter/material.dart'
    show Colors, Color, Offset, TextPainter, TextSpan, TextStyle, TextDirection, Shadow;
...
class SnakePlayer extends Component
  ...
  @override Color get skinBodyColor    => skin.bodyColor;
  @override Color get skinBodyColorDark => skin.bodyColorDark;
  @override Color get skinAccentColor  => skin.accentColor;
  @override String get skinId          => skin.id;
  @override Paint get eyeWhite  => _eyeWhite;
  @override Paint get eyePupil  => _eyePupil;

  // ── PlayerRenderer overrides ─────────────────────────────────
  @override SnakeEngine get engine => _engine;
  @override List<Vector2> get segments => _segments;
  @override bool get isAlive    => _isAlive;
  ...
  @override double get tongueTimer => _tongueTimer;
  @override Paint get bodyPaint      => _bodyPaint;
  @override Paint get headPaint      => _headPaint;
  @override Paint get shadowPaint    => _shadowPaint;
  @override Paint get highlightPaint => _highlightPaint;
  @override Paint get boostGlowPaint => _boostGlowPaint;
  @override Paint get accentRingPaint => _accentRingPaint;
  @override TextPainter get namePainter => _namePainter;
  ...
  void _applySkin() {
    ...
    _accentRingPaint.color = skin.accentColor.withOpacity(0.5);
  }
  ...
  void grow(int amount) {
    ...
    for (int i = 0; i < amount; i++) _segments.add(_segments.last.clone());
  }

  /// Credita moedas/diamantes em tempo real ao completar marcos.
  /// 50 comidas = 1 moeda, 100 = 2, etc. 49 não vale.
  /// 5000 comidas = 1 diamante.
  ...
  // ── Render ───────────────────────────────────────────────────
  @override
  void render(Canvas canvas) => renderPlayer(canvas); // PlayerRenderer
}
