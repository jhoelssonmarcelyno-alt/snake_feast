...
/// Cabeca de kraken - usa FallbackHead ate ter arte propria.
/// Para dar arte exclusiva, substitua paintFront abaixo.
class KrakenHead extends HeadPainter {
  static final KrakenHead _i = KrakenHead._();
  KrakenHead._();
  factory KrakenHead() => _i;
