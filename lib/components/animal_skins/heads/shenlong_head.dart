...
/// Cabeca de shenlong - usa FallbackHead ate ter arte propria.
/// Para dar arte exclusiva, substitua paintFront abaixo.
class ShenlongHead extends HeadPainter {
  static final ShenlongHead _i = ShenlongHead._();
  ShenlongHead._();
  factory ShenlongHead() => _i;
