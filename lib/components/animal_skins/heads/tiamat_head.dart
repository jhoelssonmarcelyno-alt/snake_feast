...
/// Cabeca de tiamat - usa FallbackHead ate ter arte propria.
/// Para dar arte exclusiva, substitua paintFront abaixo.
class TiamatHead extends HeadPainter {
  static final TiamatHead _i = TiamatHead._();
  TiamatHead._();
  factory TiamatHead() => _i;
